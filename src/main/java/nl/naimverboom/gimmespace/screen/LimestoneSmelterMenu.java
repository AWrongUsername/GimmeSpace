...
import nl.naimverboom.gimmespace.block.entity.LimestoneSmelterBlockEntity;

public class LimestoneSmelterMenu extends AbstractContainerMenu {
    public final LimestoneSmelterBlockEntity blockEntity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.LIMESTONE_SMELTER.get());
    }
